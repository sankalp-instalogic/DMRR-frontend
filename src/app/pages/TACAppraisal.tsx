...
//   {activeTab === "new"
//     ? `TAC Committee Evaluation : ${selectedProposal.id} - ${selectedProposal.projectName}`
//     : `Revised TAC Evaluation : ${selectedProposal.id} - ${selectedProposal.projectName}`}
// </h3>
...
// {activeTab === "revised" ? (
//   <div className="mt-8">
//     <h4 className="font-bold text-primary mb-4">Revised TAC Evaluation</h4>
...
//       <button onClick={() => { alert("Proposal forwarded successfully to SEC"); navigate("/sec-review"); }} className="px-6 py-3 bg-blue-600 text-white rounded-lg flex items-center gap-2 hover:bg-blue-700 transition-colors font-medium text-sm">
//         <Forward className="size-5" /> Forward to SEC Review
//       </button>
//     </div>
//   </div>
// ) : (
