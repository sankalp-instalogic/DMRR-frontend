...
export function DocumentUploadScreen() {
  ...
  const getStatusIcon = (status: OCRStatus) => {
    switch (status) {
      case "pending":
        return <AlertCircle className="size-5 text-muted-foreground" aria-hidden="true" />;
      case "processing":
        return <Loader2 className="size-5 text-info animate-spin" aria-hidden="true" />;
      case "done":
  ...
  const getStatusColor = (status: OCRStatus) => {
    switch (status) {
      ...
      case "processing":
        return "bg-info-muted border-info-border text-info-muted-foreground";
      case "done":
        return "bg-success-muted border-success-border text-success-muted-foreground";
      case "failed":
        return "bg-destructive-muted border-destructive-border text-destructive-muted-foreground";
    }
  };
    ...
    <div className="space-y-6">
          ...
          >
            ...
            <div className="flex-1">
              ...
              {ocrStatus === "processing" && (
                <div
                  className="mt-2 bg-card/50 rounded-full h-2 overflow-hidden"
                  role="progressbar"
      ...
      <div className="bg-info-muted border border-info-border rounded-xl p-4">
        <div className="flex items-start gap-3">
          <AlertCircle className="size-5 text-info shrink-0 mt-0.5" aria-hidden="true" />
          <div>
            <p className="font-semibold text-info-muted-foreground mb-1">Document Upload Guidelines</p>
            <ul className="text-sm text-info-muted-foreground space-y-1 list-disc list-inside">
