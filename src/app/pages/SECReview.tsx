...
const initialRevisedProposals = [
  ...
  },
  {
    ...
    revisionReason: "Clarification needed on land acquisition.",
    lastMembers: [
      { srNo: 1, name: "Mr. B. Patil", designation: "Revenue Secretary" },
    ]
  },
];
...
export function SECReview() {
  ...
  const handleForwardToNextStage = () => {
    ...
    alert(`Proposal forwarded to Administrative Approval successfully`);
    removeFromList();
    clearForm();
    setSelectedProposal(null);
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1>SEC Review</h1>
        <p className="text-sm text-muted-foreground">State Empowered Committee review and approval</p>
      </div>
        ...
        <table className="w-full">
          <thead className="bg-muted">
            <tr>
              ...
              <th className="px-6 py-4 text-left text-sm font-medium">Estimated Cost (₹ Cr)</th>
...
{activeTab === "revised" ? (
          <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-end mt-6">
                <button onClick={() => { alert("Proposal forwarded successfully to Administrative Approval"); navigate("/administrative-approval"); }} className="px-6 py-3 bg-blue-600 text-white rounded-lg flex items-center gap-2 hover:bg-blue-700 transition-colors font-medium text-sm">
                  <Forward className="size-5" /> Forward to Administrative Approval
                </button>
              </div>
            </div>
          </div>
  ...
  <>
          <div className="bg-card border border-border rounded-xl p-6 shadow-sm">
            <h3 className="mb-4 text-lg font-bold border-b pb-2">
              SEC Committee Evaluation : {selectedProposal.id} - {selectedProposal.projectName}
            </h3>
