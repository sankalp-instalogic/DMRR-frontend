...
const masterModules = [
  { title: "NDMA Guideline Registry", icon: FileText, link: "/master/ndma-guidelines", color: "bg-chart-1" },
  { title: "Budget Allocation Master", icon: IndianRupee, link: "/master/budget", color: "bg-chart-2" },
  { title: "Officer Master", icon: Users, link: "/master/officer", color: "bg-chart-3" },
  { title: "District Master", icon: MapPin, link: "/master/district", color: "bg-chart-4" },
  { title: "Taluka Master", icon: MapPin, link: "/master/taluka", color: "bg-chart-5" },
  { title: "Department Master", icon: Building2, link: "/master/department", color: "bg-chart-1" },
  { title: "Vendor Master", icon: HardHat, link: "/master/vendor", color: "bg-chart-2" },
  { title: "Equipment Catalogue", icon: Package, link: "/master/equipment", color: "bg-chart-3" },
];
