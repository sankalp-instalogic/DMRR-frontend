...
import { Search, Filter, FileText, ShoppingCart, IndianRupee, Building2, Eye, Edit } from "lucide-react";
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-[#0B1F4D]">Procurement Dashboard</h1>
      ...
      <div className="bg-card border border-border rounded-xl p-5 shadow-sm">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
          ...
          <div>
            <label className="block text-sm font-medium mb-1">Line Department</label>
            <select
              value={department}
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-card border border-border rounded-xl p-5 shadow-sm">
          ...
          <div className="text-lg font-bold mb-1 line-clamp-1">Rural Development</div>
          <div className="text-xs text-muted-foreground">Highest Beneficiary Department</div>
        </div>
      </div>
      ...
      <div className="bg-white border border-border rounded-xl shadow-sm overflow-hidden">
        <div className="p-5 border-b border-border">
          <h2 className="text-lg font-semibold text-[#0B1F4D]">Procurement Records</h2>
        </div>
          ...
          <table className="w-full text-sm text-left">
            <thead className="bg-muted text-muted-foreground">
              <tr>
                ...
                <th className="px-4 py-3 font-medium">Beneficiary Department</th>
